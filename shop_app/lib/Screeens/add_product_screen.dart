...
class _AddProductScreen extends State<AddProductScreen> {
  ...
  final _tempStrController = TextEditingController();
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            if (_tempStrController.text.isEmpty) {
                            ...
                            var tempString = _tempStrController.text;
                            setState(() {
                              // if(_tempStrController.text.isNotEmpty){
                              _attributes[_tempStrController.text] = [..._list];
                              _tempStrController.clear();
                              _list.clear();
                              _selectedtype = null;
                              // }
                            });
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content:
                                    Text("Attributes named $tempString added"),
                              ),
                            );
                            if (kDebugMode) {
                              print(_attributes);
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            setState(() {
                              // if(_tempStrController.text.isNotEmpty){
                              _attributes[_tempStrController.text] = {
                                ..._mapColors
                              };
                              _tempStrController.clear();
                              if (kDebugMode) {
                            ...
                            child: Column(
                              children: [
                                ...
                                if (isListExpanded == true &&
                                    e.value.runtimeType == List<String>)
                                  AttributeListViewer(
